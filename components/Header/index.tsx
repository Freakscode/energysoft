...
export default function Header() {
  return (
    <div className="flex flex-col gap-8 items-center max-h-full">
      ...
      <p className="text-4xl lg:text-4xl !leading-tight mx-auto max-w-4xl text-center bg-clip-text text-transparent bg-gradient-to-tr from-green-500 to-purple-300 font-extrabold">
        SENSADO Y MONITOREO DE CONSUMO DE ENERGÍA ELÉCTRICA PARA HOGARES
      </p>
      ...
      CONSULTA, ANALIZA Y VISUALIZA TU CONSUMO ELÉCTRICO EN TIEMPO REAL.
      </p>
